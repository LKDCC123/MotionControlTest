	...
	integer *ierr)
{
    ...
    /* Local variables */
    static thread_local integer i__, j, l, r__, l1;
    static thread_local doublereal t1, gc, gs, nu, tt;
    static thread_local integer it1, nvl;
    static thread_local doublereal sum;
    static thread_local integer info;
    static thread_local doublereal temp;
    static thread_local integer iwrm, iwrv, iwsv, iwuv, iwzv;
    static thread_local logical t1inf, t2min;
    ...
    static thread_local integer iwnbv;
